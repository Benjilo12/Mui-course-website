        ...
        <Grid item xs={4} sm={4} md={4}>
          <Card sx={styles.card}>
            ...
            <List>
              ...
              <ListItem sx={styles.ListItem}>
                <Box component="img" src={close_item} /> Practice quizes &
                assignments
              </ListItem>
              <ListItem sx={styles.ListItem}>
                <Box component="img" src={close_item} /> In depth explanations
              </ListItem>
              <ListItem sx={styles.ListItem}>
                <Box component="img" src={close_item} /> Personal instructor
                Assitance
              </ListItem>
            </List>
            <Typography sx={styles.price}>$55</Typography>
        ...
        <Grid item xs={4} sm={4} md={4}>
          <Card sx={styles.card}>
            ...
            <List>
              ...
              <ListItem sx={styles.ListItem}>
                <Box component="img" src={aprove} /> Practice quizes &
                assignments
              </ListItem>
              <ListItem sx={styles.ListItem}>
                <Box component="img" src={close_item} /> In depth explanations
            ...
            <Typography sx={styles.price}>$60</Typography>
            <Button sx={styles.btnCard}>Purchase Course</Button>
          </Card>
        </Grid>
        <Grid item xs={4} sm={4} md={4}>
          <Card sx={styles.card}>
            ...
            <List>
              ...
              <ListItem sx={styles.ListItem}>
                <Box component="img" src={aprove} /> In depth explanations
              </ListItem>
              <ListItem sx={styles.ListItem}>
                <Box component="img" src={aprove} /> Personal instructor
                Assitance
              </ListItem>
            </List>
            <Typography sx={styles.price}>$65</Typography>
            <Button sx={styles.btnCard}>Purchase Course</Button>
          </Card>
        </Grid>
      </Grid>
